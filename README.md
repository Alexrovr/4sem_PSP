...
### Задачи по варианту 6

**Вариант 6** требовал реализации:
- ✅ Миграция с XMLHttpRequest на Fetch API
- ✅ Использование async/await для асинхронных операций
- ✅ Работа с Promise и обработка ошибок
- ✅ Сборка фронтенда через Vite
- ✅ Развертывание приложения как полностью готовой системы
- ✅ API для получения списка вакансий (GET)
- ✅ API для создания новой вакансии (POST)
- ✅ Интерфейс для просмотра и создания вакансий
